package com.windcoder.qycms.generator.enums;
...
public class EnumGenerator {
    static String path = GeneratorPathUtils.TO_VUE_CONSOLE_PUBLIC_W+"\\static\\js\\enums.js";
    ...
    public static void main(String[] args) {
        ...
        try {
            toJson(MenusAgentIdentifier.class, bufferObject, bufferArray);
