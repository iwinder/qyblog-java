...
--  *********************************************************************
--  Change Log: G:/none/Java/idea/qycms/db/liquibase/changelog-mysql-master-20181214170848.yaml
--  Ran at: 18-12-14 下午5:08
...
--  Lock Database
UPDATE qycmstest.DATABASECHANGELOGLOCK SET `LOCKED` = 1, LOCKEDBY = 'DESKTOP-SI04Q2I (172.19.102.97)', LOCKGRANTED = '2018-12-14 17:08:55.16' WHERE ID = 1 AND `LOCKED` = 0;
